...
@section('title'){{'Create colors'}}@endsection
@section('content')
    {{--wrapper--}}
<div class="wrapper">
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <label for="inputName">Tên màu sắc</label>
                                <input type="text" id="slug" onkeyup="ChangeToSlug();" class="form-control" name="inputName">
                            </div>
                            <div class="form-group">

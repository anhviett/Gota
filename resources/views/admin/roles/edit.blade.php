                ...
                <div class="row">
                    <div class="col-md-8 mx-auto">
                        <div class="card card-primary">
                            ...
                            <form action="{{route('role.update',$roles->id)}}" method="POST" style="width: 100%">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-lg-4">
                                            @csrf
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="role_name" class="form-control" id="role_name_edit" value="{{$roles->name}}">
                                            </div>
                                            <div class="form-group">
                                                <label for="display_name">Mô tả vai trò</label>
                                                <textarea class="form-control" name="display_name"
                                                          id="" cols="30" rows="10" style="height: 41px"> {{$roles->display_name}}
                                        </textarea>

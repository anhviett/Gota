                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Sửa banar</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                ...
                <div class="row">
                    <div class="col-md-8 mx-auto">
                        <div class="card card-primary">
                            ...
                            <form action="{{route('banar.update',$banars->id)}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    <div class="form-group position-relative text-center">
                                        <div style="position: absolute;  left: 0;">Ảnh :</div>
                                        <img class="imagesForm" width="100" height="100" src="
                            {{asset('/uploads/').'/'.$banars->images}}"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea type="text" id="inputTitle" class="form-control" name="inputTitle"
                                                  >{{$banars->title}}</textarea>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputDescription">Mô tả</label>
                                        <input type="text" id="inputDescription" class="form-control" name="inputDescription"
                                               value="{{$banars->description}}">
                                    </div>
                                    <div class="form-group">
                                        <label for="inputBottom">Phần đáy</label>
                                        <input type="text" id="inputBottom" class="form-control" name="inputBottom"
                                               value="{{$banars->bottom}}">
                                    </div>
